    ...
    <div className="footer-font bg-[#001B37] relative overflow-hidden font-sans w-[100%] lg:px-20">
      ...
      <div className="container mx-auto w-[90%] px-4 py-8 flex flex-col">
        <div className="flex flex-col md:flex-row justify-between flex-grow">
          ...
          {/* Right navigation */}
          <nav className="space-y-1 z-50 text-white text-[20px] md:text-[50px] font-bold leading-none">
            <ul className="lg:space-y-5 sm:space-y-2 mt-[10%]">
              <li>
                <Link
                  href="#link1"
        ...
        <div className="flex flex-col md:flex-row mt-24">
          ...
          <div className="flex flex-col justify-center md:w-1/2 gap-10">
            <Image src="/footer1.svg" alt="Image 1" width={200} height={150} className="m-2" />
            <Image src="/footer2.svg" alt="Image 2" width={425} height={150} className="m-2" />
            <Image src="/footer3.svg" alt="Image 3" width={380} height={150} className="m-2" />
          
          </div>

          {/* Right image section with 1 image */}
       <div className="flex justify-center md:w-1/2 ">
  <Image src="footerbackground.svg" alt="Image 5" width={800} height={300} className="m- absolute right-0 bottom-0" />
</div>
        </div>
      </div>
